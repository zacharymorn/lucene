...
class BlockMaxMaxscoreScorer extends Scorer {
  ...
  BlockMaxMaxscoreScorer(Weight weight, List<Scorer> scorers, ScoreMode scoreMode)
    ...
    scalingFactor = WANDScorer.getScalingFactor(scorers).orElse(0);
